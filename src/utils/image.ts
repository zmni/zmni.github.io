 ...
 */
const allImages = import.meta.glob<{ default: ImageMetadata }>("/src/assets/**/*.{gif,jpg,png,jpeg,svg,webp}", {
  eager: true,
});
 ...
 * @param path Path lengkap gambar (misal: /src/assets/folder/gambar.jpg)
 * @returns ImageMetadata atau undefined jika tidak ditemukan
 */
export const getImageByPath = (path: string): ImageMetadata => {
